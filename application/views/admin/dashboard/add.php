    <div class="container top">
      ...
      ?>
      <div style="width:50%;float:left;height: 458px;">
        <fieldset>
        <legend>Personal Information </legend>
          ...
          </div>            <div class="control-group">            <label for="inputError" class="control-label">Nick Name</label>            <div class="controls">              <input type="text" id="" name="nick_name" value="<?php echo set_value('nick_name'); ?>">              <!--<span class="help-inline">Cost Price</span>-->            </div>          </div>	
           <div class="control-group">            <label for="inputError" class="control-label">Employee ID</label>            <div class="controls">              <input type="text" id="" name="employee_id" value="<?php echo set_value('employee_id'); ?>">              <!--<span class="help-inline">Cost Price</span>-->            </div>          </div>		  
          <div class="control-group">
         ...
         <div class="control-group">
		   ...
		   <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="blood_group" value="<?php echo set_value('blood_group'); ?>"  >
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
...
<fieldset>
    ...
    <div class="control-group">
     ...
     <div class="control-group">
          ...
          </div>		  <div class="control-group">            <label for="inputError" class="control-label">Location</label>            <div class="controls">              <input type="text" id="" name="location" value="<?php echo set_value('location'); ?>">              <!--<span class="help-inline">Cost Price</span>-->            </div>          </div>		  		  <div class="control-group">            <label for="inputError" class="control-label">Office Location</label>            <div class="controls">              <input type="text" id="" name="office_location" value="<?php echo set_value('office_location'); ?>">              <!--<span class="help-inline">Cost Price</span>-->            </div>          </div>		  		  <div class="control-group">            <label for="inputError" class="control-label">Exit date</label>            <div class="controls">              <input type="text" id="" name="exit_date" value="<?php echo set_value('exit_date'); ?>">              <!--<span class="help-inline">Cost Price</span>-->            </div>          </div>
          <div class="control-group">
...
<div style="width:50%;float:left;min-height:300px; margin-top:35px">
<fieldset>
