...
//print_r($employee_details);
      ...
      ?>
        <div style="width:50%;float:left;height: 680px;">
        <fieldset>
        <legend>Employee Dedails</legend>
          ...
          </div>          <div class="control-group">            <label for="inputError" class="control-label">Nick Name</label>            <div class="controls">              <input type="text" id="" name="team_profile_nick_name" value="<?php echo $employee_details[0]['team_profile_nick_name']; ?>" >              <!--<span class="help-inline">Woohoo!</span>-->            </div>          </div>
		 
		 <div class="control-group">            <label for="inputError" class="control-label">Employee ID</label>            <div class="controls">              <input type="text" id="" name="team_profile_employee_id" value="<?php echo $employee_details[0]['team_profile_employee_id']; ?>" >              <!--<span class="help-inline">Woohoo!</span>-->            </div>          </div>
         ...
         <?php
          echo '<div class="control-group">';
            ...
            echo '<div class="controls">';
             ...
             // form_dropdown('gender', $options, $status);
              echo form_dropdown('groups_id', $options_manufacture, $employee_details[0]['team_profile_job_position_title']);
         ...
         <input type="hidden" id="team_profile_job_position_title" name="team_profile_job_position_title" value="<?php echo $employee_details[0]['team_profile_job_position_title'];?>">
          ...
          </div>		  <div class="control-group">            <label for="inputError" class="control-label">Location</label>            <div class="controls">              <input type="text" name="team_profile_location" value="<?php echo $employee_details[0]['team_profile_location']; ?>" class="form-control" >              <!--<span class="help-inline">Woohoo!</span>-->            </div>          </div>		  <div class="control-group">            <label for="inputError" class="control-label">Office Location</label>            <div class="controls">              <input type="text" name="team_profile_office_location" value="<?php echo $employee_details[0]['team_profile_office_location']; ?>" class="form-control" >              <!--<span class="help-inline">Woohoo!</span>-->            </div>          </div>
...
<div style="width:50%;float:left;height: 550px;">
 <fieldset>
 <legend></legend>
  <div class="control-group">
        ...
        <div class="control-group">
		   ...
		   <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="blood_group" class="form-control" value="<?php echo $employee_details[0]['team_profile_employee_blood_gp']; ?>">
              <!--<span class="help-inline">Woohoo!</span>-->
            </div>
          </div>
     ...
     <div class="control-group">
          ...
          </div>   <div class="control-group">            <label for="inputError" class="control-label">Exit Date</label>            <div class="controls">              <input type="datetime" class="join_date" name="team_profile_exit_date"  value="<?php echo $employee_details[0]['team_profile_exit_date']; ?>">              <!--<span class="help-inline">Cost Price</span>-->            </div>          </div> 		  
