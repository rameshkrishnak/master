    ...
    */
    public function __construct()
    {
       ...
       // $this->load->model('manufacturers_model');
        ...
        } else if ($this->session->userdata('is_logged_in') && $this->session->userdata('user_group')=='5'){
...
//print_r($data);
           ...
           // $this->form_validation->set_rules('certifation', 'certifation//pervious details', 'required');
            ...
            if ($this->form_validation->run())
            {
                ...
                $data_to_store = array(
					...
					'team_profile_nick_name' =>  $this->input->post('nick_name'),
					'team_profile_employee_id' =>  $this->input->post('employee_id'),
					...
					'team_profile_city'=>$this->input->post('location'),
					'team_profile_location'=>$this->input->post('office_location'),
					'team_profile_office_location'=>$this->input->post('email'),
					'team_profile_present_address'=>$this->input->post('local_address'),
					'team_profile_employee_blood_gp'=>$this->input->post('blood_group'),
					...
					'team_profile_exit_date'=>$this->input->post('exit_date')
  ...
  //echo $id ;
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
			...
			$this->form_validation->set_rules('team_profile_nick_name', 'Name', 'required');
            ...
            if ($this->form_validation->run())
            {
                ...
                $data_to_store = array(
					...
					'team_profile_nick_name' => $this->input->post('team_profile_nick_name'),
                    'team_profile_groups_id' => $this->input->post('groups_id'),
                    'team_profile_username' => $this->input->post('team_profile_username'),
					'team_profile_employee_id' => $this->input->post('team_profile_employee_id'),
                    'team_profile_status' => $this->input->post('status'),          
                    'team_profile_telephone' => $this->input->post('team_profile_telephone'),
					'team_profile_city' => $this->input->post('city'),
					'team_profile_location' => $this->input->post('team_profile_location'),
					'team_profile_office_location' => $this->input->post('team_profile_office_location'),
                    'team_profile_state' => $this->input->post('state'),
                    ...
                    'team_profile_job_title' => $this->input->post('job_title'),
                    'team_profile_join_date' => $this->input->post('join_date'), 
                    'team_profile_exit_date' => $this->input->post('team_profile_exit_date')					
